                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="main_curd">
                                                                <a href="<?= base_url('user/' . $user_id . '/invoice/view/' . $row->id) ?>" class="btn a-btn btn-inverse-success btn-rounded btn-icon" data-toggle="tooltip" data-placement="top" title="View">
