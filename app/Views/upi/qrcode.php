...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/assets/css/css/adminx.css" media="screen" />
...
<body class="sp-background">
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <div class="col-md-12 text-center mt-1">
                                ...
                                <div class="mt-2 d-flex justify-content-center" style="max-width:100%">
                                    ...
                                    <img src="<?php echo (new QRCode)->render($response->upi_intent->upi_link) ?>" alt="QR Code" width="200">
                            ...
                            <div class="col-lg-12">
                                <input type="hidden" value="<?= $response->client_orderid ?>" id="client_orderid" name="order_id">

                            </div>
                            <div class="col-md-12 text-center mt-0">
                                <img src="<?php echo base_url() ?>public/assets/img/rectangle.png" alt="" style="width: 90%;">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        let interValId = setInterval(() => {
            ...
            if (totalTimer == 0) {
                window.location.href = '<?= base_url('student/add') ?>';
                return;
            }
    ...
    <script>
        function makeAjaxCall() {
            ...
            if (order_id) {
                $.ajax({
                    url: '<?= base_url('student/txn-status') ?>',
                    method: 'POST',
                    dataType: 'json',
                    data: {
                        order_id: order_id
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 'SUCCESS') {
                            window.location.href = '<?= base_url("student/view/paid-students") ?>';
                            clearTimeout(timer);
