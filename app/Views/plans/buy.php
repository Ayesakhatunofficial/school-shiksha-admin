...
<body>
                            ...
                            foreach ($plans as $row) { ?>
                                ...
                                <div class="col-lg-4 ">
                                    <div class="card">
                                        ...
                                        <input type="hidden" value="<?= $stud_id ?>" id="stud_id">
    ...
    <script>
        function upiTimer() {
            ...
            let interValId = setInterval(() => {
                ...
                if (totalTimer == 0) {
                    window.location.href = '<?= base_url('student/buy-subscription/' . $stud_id) ?>';
                    return;
                }
    ...
    <script>
        ...
        function initiatePaymentProcess(id) {
            ...
            $.ajax({
                url: "<?php echo base_url('student/initiatePaymentProcess'); ?> ",
                method: "POST",
                data: $(this).serialize(),
                dataType: "json",
                data: {
        ...
        function makeAjaxCall(orderId, id) {
            ...
            $.ajax({
                url: '<?php echo base_url('/student/paytmTxn-Status') ?>',
                method: 'POST',
                dataType: 'json',
                data: {
                    orderId: orderId,
                ...
                success: function(response) {
                    ...
                    if (response.status == 'SUCCESS') {
                        ...
                        window.location.href = '<?= base_url(sprintf('student/buy-subscription/%s?payment_status=success', $stud_id)) ?>';
                    }
